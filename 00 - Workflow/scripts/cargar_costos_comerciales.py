...
estado_path = estado_dir / "estado_costos_comerciales.txt"
...
try:
    ...
    if "Costos Comerciales" in [s.name for s in wb.sheets]:
        sht = wb.sheets["Costos Comerciales"]
        sht.clear()
    else:
        sht = wb.sheets.add("Costos Comerciales")

    # ================================
    #   ENCABEZADO
    # ================================
    sht.range("A1").value = "Costos Comerciales"
    ...
    with open(estado_path, "w") as f:
        f.write(
            f"Completado! Costos Comerciales cargados correctamente - "
